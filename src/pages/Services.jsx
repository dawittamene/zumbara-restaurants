...
import Img2 from '../assets/doro_wet.jpg'
import Img3 from '../assets/kikile.jpg'
import Img4 from '../assets/ktfo.jpg'
import Img5 from '../assets/beyaynet.jpg'
import Img6 from '../assets/shero.jpg'
  ...
  return (
    <>
        ...
        <div className=' container'>
            ...
            {/* cards section */}
            <div>
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-14 mt-10 md:gap-5 place-items-center '>
                    {
                            ...
                            key={id} className=' max-w-[300px] group rounded-2xl bg-white
                             dark:bg-gray-800 hover:bg-primary hover:text-white duration-300 p-4 cursor-pointer shadow-xl'>
                                <div className='h-[100px]'>
                                    <img src={image}  alt="" 
                                    className='w-[50%]  max-w-[200px] mx-auto block transform -translate-y-14 group-hover:scale-105 group-hover:rotate-6 duration-300'
                                    />
                                </div>
                                <div>
